...
export const SUBCATEGORIES = {
  ...
  HOME_SALE: "home_sale",
  TRANSPORT: "transport_for_sale",
  MOTORCYCLE: "bike_rentals",
  CAR: "car_rentals",
...
export const categoryToSubcategoriesMapping = {
  ...
  [CATEGORIES.KIDS]: [
    SUBCATEGORIES.BABY_GEAR,
    SUBCATEGORIES.TOYS,
    SUBCATEGORIES.KIDS_CLOTHING,
  ],
  [CATEGORIES.SERVICES]: [
  ...
  [CATEGORIES.PETS]: [
    SUBCATEGORIES.PET_ADAPTION,
    SUBCATEGORIES.PET_SUPPLY,
    SUBCATEGORIES.PET_SERVICE,
  ],
  [CATEGORIES.OTHER]: [
    SUBCATEGORIES.BOOK,
    SUBCATEGORIES.MUSIC,
